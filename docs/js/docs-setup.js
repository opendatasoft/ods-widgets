NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "add api button clipboard copy directive find gist gist-id github html integrates module ods-widgets opendatasoft url username widget"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "adds angularjs api arbresremarquablesparis2011 array build catalog class context dataset directive exposes fields html item items list matching maximum module ng-repeat ngrepeat nhits nom_commun nom_ev number ods-results ods-results-context ods-results-max ods-widgets odsresultscontext odsresultsmax opendatasoft parisdata property query records scope search simply sort table table-bordered table-condensed table-striped total tree tree-dataset tree-domain tree-parameters trees variable widget"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "add api array attribute autofocus box button catalog changes cibul cibul-dataset cibul-domain cibul-field content context contexts dataset default directive display displays don donnees-sur-les-medecins-accredites empty evenements-publics-cibul example explicitely field fields focus full-text html inner input language libelle_long_de_la_specialite_du_medecin medecins medecins-dataset medecins-domain medecins-field module multiple mycontext-field ods-widgets opendatasoft operators overriding parameter placeholder prevents primary public query restrict search searchbox secondary set simple specific suffix suffixvalue support syntax text text-search textual title widget widgets won works"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "add angularjs animate api button cibul cibul-dataset cibul-domain click cnt condition context count dashboards day default-from default-to delay directive doesn evenements-publics-cibul events example exec execute executes executing expression false field html increase milliseconds minimum module moment momentadd ng-init number ods-aggregation ods-aggregation-context ods-aggregation-function ods-widgets opendatasoft pause public returning seconds simple stop-condition stopcondition stops timer true user values wait widget yyyy-mm-dd"
    },
    {
      "section": "api",
    ...
    },
    {
      ...
      "keywords": "access allows api appear array calling cheese cheese-dataset cheese-domain compiled configure context custom default directive displayedfields displaying fields frenchcheese getrecordtitle helper html lists module ods-widget-tooltip ods-widgets opendatasoft public record rendering template tooltip usable widget"
    },
    {
      "section": "api",
