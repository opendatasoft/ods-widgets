...
plugged on a remote data API (currently Huwise only); those directives
...
This library is used in production as a part of the Huwise platform, a
...
#### [> Tutorial](https://help.huwise.com/widgets/#/getting-started/)
...
#### [> Reference Documentation](https://help.huwise.com/widgets/#/getting-started/01widgetdoc)
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="//static.huwise.com/ods-widgets/latest-v2/ods-widgets.min.css">
    </head>
    <body>
        ...
        <script type="text/javascript" src="//static.huwise.com/ods-widgets/latest-v2/ods-widgets.min.js"></script>
    </body>
</html>
```
...
Currently, ODS-Widgets only works with an API from a Huwise domain, or any API
that exposes the same interface and returns the same JSON result.

This project originates from Huwise codebase, and as such obviously works
...
### Contact
If you have questions, you can contact us on X (@huwise_en) or simply open a GitHub issue.
